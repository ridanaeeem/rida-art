...
export default function Nav() {
	...
	return (
		<nav>
			<div className="bg-white text-black lg:px-20">
				<div className="header flex flex-col font-bold max-md:items-center">
					<h1
				...
				<ul className="text-xl md:text-3xl flex font-normal max-md:text-center max-md:justify-center ">
					<div className="flex justify-center items-center">
						...
						<a href="https://photos.rnaeem.com" target="_blank" className="px-5">
							Photos
						</a>
					</div>
				</ul>
